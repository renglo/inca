...
class GenerateBundles:
    ...
    def run(self, payload):
        ...
        try:
            ...
            response_1 = Sprinter().run(sprinter_payload)
            ...
            return {'success': False, 'function': function, 'input': payload, 'output': f'ERROR:@generate_bundles/run: {str(e)}'}
